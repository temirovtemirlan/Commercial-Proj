      ...
      <Container className={"py-[70px]"}>
        <div className={"flex justify-between xl:flex-row flex-col"}>
          ...
          <p className="text-black text-2xl grow-1 xl:max-w-[800px] mt-8 md:mt-0 text-balance">
            ...
            Забудьте про бесконечные PDF — всё, что вам нужно, доступно онлайн в
            один клик.
          </p>
        </div>
      </Container>
      ...
      <Container className="bg-[#f5f5f7] xl:pt-[100px] pt-[50px] text-center">
        <div className="w-full text-center">
          ...
          <p className="text-1lvl">
            Мы не просто создаем бренды, контент и технологии. <br /> Мы строим
            реальность, которой хочется быть частью. <br /> <br />В мире, где
            каждый борется за внимание, выигрывают те, кто умеет <br />
